...
const SECRET_KEY     = '6LfD1xQrAAAAAJOSDYPVIcYIHd06YUsNWFZoH5B7';              // Google reCAPTCHA secret key
const SMTP_HOST      = 'mail.da-christian.xyz';                       // SMTP server hostname
const SMTP_USERNAME  = 'ismael@da-christian.xyz';                       // SMTP username
const SMTP_PASSWORD  = 'sC5*H4jzKfNpdg!';                       // SMTP password
...
const FROM_NAME      = 'Mon Portfolio';                // Sender name
